...
INSERT INTO goal(id, goal) VALUES ('1e0d7c46-2194-4a30-b8e5-1b0a7c287e81', jsonb_build_object('title', 'Learn React', 'description', 'Learn React', 'recurrence', '1 day', 'author', (SELECT id FROM "user" WHERE data->>'email' = 'hunter@ucsc.edu'), 'memberCount', 1));
INSERT INTO goal(goal) VALUES (jsonb_build_object('title', 'Walk a mile', 'description', 'Walk a mile every day to be healthy!', 'recurrence', '1 day', 'memberCount', 1));
INSERT INTO goal(goal) VALUES (jsonb_build_object('title', 'Eat breakfest at 9am', 'description', 'Eat breakfest at an early time to stay consistant!', 'recurrence', '1 day', 'memberCount', 1));
INSERT INTO goal(goal) VALUES (jsonb_build_object('title', 'Do your 114A homework', 'description', 'CSE 114A homework due on tuesday at 11:59pm', 'recurrence', '1 week', 'memberCount', 1));
INSERT INTO goal(goal) VALUES (jsonb_build_object('title', 'Get your mom a gift on mothers day', 'description', 'May 14th is mothers day, get her a git!', 'recurrence', '1 year', 'memberCount', 1));
INSERT INTO goal(goal) VALUES (jsonb_build_object('title', 'Go to the gym', 'description', 'Toadal fitness baybe', 'recurrence', '2 days', 'memberCount', 1));
